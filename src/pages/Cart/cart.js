      ...
      {cart.length >= 1 ? (
         ...
         <h1 className='m-6 font-bold text-2xl'>Order Summary</h1>
          {cart.map((item) => (
           <div>
            ...
            <div key={item.product.id} className=" border  p-4 mb-4 shadow-md rounded-md">
              ...
              <div className="flex justify-center items-center ">
                ...
                <div className="flex items-center ml-auto">
                  ...
                  <div className="ml-2 cursor-pointer bg-blue-500 rounded-md p-2 text-white hover:bg-blue-400 shadow-xl" onClick={() => removeFromCart(item.product.id)}>
                    Remove
                  </div>
                </div>
              </div>
            ...
            <div className="payment  p-3 shadow-md rounded-md">
              ...
              <div className="summary py-3 my-2 font-bold">
                <div className="flex py-1 justify-around ">
                  <span>Subtotal:</span>
                  <span className="text-blue-700 ">${Math.round(Total(), 2)}</span>
                </div>
                <div className="flex py-1 justify-around">
                ...
                <div className="flex py-1 justify-around mt-8 ">
                  ...
                  <span>Total:</span>
                  <span className="text-blue-700">${Math.round(Total() + SHIPPING_CHARGES, 2)}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-md py-8 px-6 bg-white shadow-md rounded-lg">
          <div className="flex items-center justify-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 ml-3">Cart is empty</h2>
          </div>
          <p className="text-gray-600 mt-4">
            There are no items in your cart. Start shopping now to add products.
          </p>
        </div>
      </div>
      )}
